...
if os.path.exists(db_path):
    # Conecta no banco e lê tudo usando pandas
    ...
    if not df.empty:
        ...
        # Gráfico de barras: Vagas por dia
        ...
        # Mostra a tabela formatada, do mais recente para o mais antigo
